...
all: labyrinth_main.o labyrinth_generation.o sdl_main.o sdl_main_hwsw.o parameters.o
	$(CC) -o labyrinth labyrinth_main.o labyrinth_generation.o sdl_main.o sdl_main_hwsw.o parameters.o help.o $(SDL_LDFLAGS) -lSDL2_image 
